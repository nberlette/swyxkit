...
const GIT_REPO_URL = new URL(env.REPOSITORY_URL ?? 'https://github.com/nberlette/swyxkit.git');
export const GH_USER_REPO = (env.GH_USER_REPO ?? 'nberlette/swyxkit');
export const REPOSITORY_URL = env.REPOSITORY_URL ?? GIT_REPO_URL.href;
